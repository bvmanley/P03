...
public class GradebookWriter extends PrintWriter {
     ...
     * PrintWriter(String). The PrintWriter ctor opens the file named by pFname
     * for writing. It will throw a FileNotFoundException if the file could not
     * be opened for writing. We throw the exception here as well where it will
    ...
    /**
     * Writes the gradebook info to the output file which was opened in the
     * ctor.
     *
     * @param pRoster The roster of students.
     *
     * PSEUDOCODE: method writeGradebook(pRoster : Roster() : void EnhancedFor
     * each student in pRoster.getStudentList() Do Call println(student) End For
     * Call close() end writeGradebook
     */
