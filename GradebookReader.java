...
public class GradebookReader {
    ...
    /**
     * Attempts to open the gradebook file for reading. If successful, mIn will
     * be used to read from the file. If the file cannot be opened, a
     * FileNotFoundException will be thrown.
     *
     * Note that this method does not actually read the information from the
     * file. That is done lated when readRoster() is called from Main.run().
     *
     * @throws FileNotFoundException
     *
     * @param pFname The name of the file to be opened for reading. For this
     * project it will be "gradebook.dat"
     */
     ...
     *
     * The number of exams is retrieved by calling the static getNumExams()
     * method in Main.
     *
     ...
     *
     * @param pStudent The student for whom we are going to read the homework
    ...
    /**
     * Reads the student information for each student in the input file, adding
     * each student to the roster.
     *
